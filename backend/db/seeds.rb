...
Admin.create(username: '#1098', password: 'jxmxe')
Admin.create(username: '#9987', password: 'honxe')
# Admin.create(username: '#6543', password: 'moxdeyx')
# Admin.create(username: '#2150', password: 'loxelyx')
